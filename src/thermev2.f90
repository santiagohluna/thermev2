...
!-----------------------------------------------------------------------
!              1       2       3       4       5       6
11  format(1x,f5.3,1x,f7.2,1x,f7.2,1x,f7.2,1x,f4.2,1x,f4.2,1x, &
!           7       8       9       10 
           f6.2,1x,f7.2,1x,f6.2,1x,f6.2,1x, &
!           11      12      13      14  
           f7.2,1x,f7.2,1x,f7.2,1x,f7.2,1x, &
!           15      16       17         18        19
           f7.2,1x,f7.2,1x,es8.2e2,1x,es8.2e2,1x,f5.3)
...
!       ----------------------------------------------------------------
!                    1   2   3    4   5    6
        write(11,11) t,Tcmb,Tubl,Tpot,ur,urtot, &
!                    7     8       9     10  
